...
class LedgerTrie_test : public beast::unit_test::suite
{
    ...
    testSupport()
    {
        ...
        BEAST_EXPECT(t.uncommittedSupport(Seq{0}) == 0);
        BEAST_EXPECT(t.uncommittedSupport(Seq{3}) == 0);
        BEAST_EXPECT(t.uncommittedSupport(Seq{1000}) == 0);
        ...
        BEAST_EXPECT(t.uncommittedSupport(Seq{0}) == 0);
        BEAST_EXPECT(t.uncommittedSupport(Seq{3}) == 0);
        BEAST_EXPECT(t.uncommittedSupport(Seq{4}) == 1);
        BEAST_EXPECT(t.uncommittedSupport(Seq{1000}) == 1);
        ...
        BEAST_EXPECT(t.uncommittedSupport(Seq{0}) == 0);
        BEAST_EXPECT(t.uncommittedSupport(Seq{3}) == 0);
        BEAST_EXPECT(t.uncommittedSupport(Seq{4}) == 2);
        BEAST_EXPECT(t.uncommittedSupport(Seq{1000}) == 2);
    ...
    testRootRelated()
    {
        ...
        BEAST_EXPECT(t.tipSupport(h[""]) == 0);
        BEAST_EXPECT(t.uncommittedSupport(Seq{0}) == 0);
        BEAST_EXPECT(t.uncommittedSupport(Seq{1}) == 0);
        BEAST_EXPECT(t.uncommittedSupport(Seq{2}) == 1);
        ...
        BEAST_EXPECT(t.uncommittedSupport(Seq{0}) == 0);
        BEAST_EXPECT(t.uncommittedSupport(Seq{1}) == 0);
        BEAST_EXPECT(t.uncommittedSupport(Seq{2}) == 2);
